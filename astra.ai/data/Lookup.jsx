...
export default {
  ...
  INPUT_PLACEHOLDER: 'How can Astra help you today?',
  SIGNIN_HEADING: 'Continue With Astra.ai',
  SIGNIN_SUBHEADING: 'To use Astra you must log into an existing account or create one.',
  SIGNIN_AGREEMENT_TEXT: 'By using Astra, you agree to the collection of usage data for analytics.',
